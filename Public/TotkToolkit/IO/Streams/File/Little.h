...
namespace TotkToolkit::IO::Streams::File {
	class Little : public TotkToolkit::IO::Streams::File::File {
	public:
		Little(std::string filePath) : TotkToolkit::IO::Streams::File::File(filePath) {

		}
		Little(std::shared_ptr<std::fstream> file) : TotkToolkit::IO::Streams::File::File(file) {
